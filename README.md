...
[![GIS Conflict Dashboard — a walkthrough: buffer conflict analysis, the live conflict rule, the density heatmap, and the H3 conflict-index cells](docs/demo.gif)](https://the-snowmen.github.io/GIS-Conflict-Dashboard/)
